...
# Input Files:
# 1) c102_funtionalProfileOutput
# 2) modified_functional_prof_core.RData
# 3) SpeciesScores.RData
# 4) combined_metabolite_map.RData
...
allFunctionOutput_Folder= "G:\\My Drive\\IIITD\\project\\control_runs\\output_files\\c102_funtionalProfileOutput\\"
...
load("G:\\My Drive\\IIITD\\project\\control_runs\\input_files\\FunctionalProfiling\\modified_functional_prof_core.RData")
...
save.image("G:\\My Drive\\IIITD\\project\\control_runs\\input_files\\FunctionalProfiling\\FunctionalClassificationAnalysis_stage2.RData")
