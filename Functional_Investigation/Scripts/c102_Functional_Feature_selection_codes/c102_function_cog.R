...
# code name- c102_function_cog_abhishek.R
...
save.image(paste0("/storage32Tb/sourav/HACK_REVISION/cog/",functionName,"_temp.RData"))

rf_df <- data.frame(Actual=rf_model$y,Predicted=rf_model$predicted)
save.image(paste0("/storage32Tb/sourav/HACK_REVISION/cog/",functionName,"_temp.RData"))

pdf(file = paste0("/storage32Tb/sourav/HACK_REVISION/cog/",functionName,"_FunctionCorPlot.pdf"), width = 15, height = 15);
...
rf_cog= rf_model
df_rf_cog= rf_df
bootstrap_rf_cog= bootstrap_model
err_rates_cog= err_rates

save(rf_cog, df_rf_cog, bootstrap_rf_cog, err_rates_cog, file= paste0("/storage32Tb/sourav/HACK_REVISION/cog/",functionName,"_Output.RData"))
