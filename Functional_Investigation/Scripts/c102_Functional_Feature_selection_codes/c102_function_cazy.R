...
# code name- c102_function_cazy_abhishek.R
...
save.image(paste0("/storage32Tb/sourav/HACK_REVISION/cazy/",functionName,"_temp.RData"))

rf_df <- data.frame(Actual=rf_model$y,Predicted=rf_model$predicted)
save.image(paste0("/storage32Tb/sourav/HACK_REVISION/cazy/",functionName,"_temp.RData"))

pdf(file = paste0("/storage32Tb/sourav/HACK_REVISION/cazy/",functionName,"_FunctionCorPlot.pdf"), width = 15, height = 15);
...
rf_cazy= rf_model
df_rf_cazy= rf_df
bootstrap_rf_cazy= bootstrap_model
err_rates_cazy= err_rates

save(rf_cazy, df_rf_cazy, bootstrap_rf_cazy, err_rates_cazy, file= paste0("/storage32Tb/sourav/HACK_REVISION/cazy/",functionName,"_Output.RData"))
