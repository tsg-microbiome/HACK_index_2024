...
# code name- c102_function_kegg_reaction_abhishek.R
...
save.image(paste0("/storage32Tb/sourav/HACK_REVISION/kegg_rxn/",functionName,"_temp.RData"))

rf_df <- data.frame(Actual=rf_model$y,Predicted=rf_model$predicted)
save.image(paste0("/storage32Tb/sourav/HACK_REVISION/kegg_rxn/",functionName,"_temp.RData"))

pdf(file = paste0("/storage32Tb/sourav/HACK_REVISION/kegg_rxn/",functionName,"_FunctionCorPlot.pdf"), width = 15, height = 15);
...
rf_kegg_reaction= rf_model
df_rf_kegg_reaction= rf_df
bootstrap_rf_kegg_reaction= bootstrap_model
err_rates_kegg_reaction= err_rates

save(rf_kegg_reaction, df_rf_kegg_reaction, bootstrap_rf_kegg_reaction, err_rates_kegg_reaction, file= paste0("/storage32Tb/sourav/HACK_REVISION/kegg_rxn/",functionName,"_Output.RData"))