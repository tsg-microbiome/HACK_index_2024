...
# code name- c102_function_BiGG_abhishek.R
...
save.image(paste0("/storage32Tb/sourav/HACK_REVISION/bigg/",functionName,"_temp.RData"))

rf_df <- data.frame(Actual=rf_model$y,Predicted=rf_model$predicted)
save.image(paste0("/storage32Tb/sourav/HACK_REVISION/bigg/",functionName,"_temp.RData"))

pdf(file = paste0("/storage32Tb/sourav/HACK_REVISION/bigg/",functionName,"_FunctionCorPlot.pdf"), width = 15, height = 15);
...
rf_BiGG= rf_model
df_rf_BiGG= rf_df
bootstrap_rf_BiGG= bootstrap_model
err_rates_BiGG= err_rates

save(rf_BiGG, df_rf_BiGG, bootstrap_rf_BiGG, err_rates_BiGG, file= paste0("/storage32Tb/sourav/HACK_REVISION/bigg/",functionName,"_Output.RData"))
