...
# code name- c102_function_kegg_module_abhishek.R
...
save.image(paste0("/storage32Tb/sourav/HACK_REVISION/kegg_mod/",functionName,"_temp.RData"))

rf_df <- data.frame(Actual=rf_model$y,Predicted=rf_model$predicted)
save.image(paste0("/storage32Tb/sourav/HACK_REVISION/kegg_mod/",functionName,"_temp.RData"))

pdf(file = paste0("/storage32Tb/sourav/HACK_REVISION/kegg_mod/",functionName,"_FunctionCorPlot.pdf"), width = 15, height = 15);
...
rf_kegg_module= rf_model
df_rf_kegg_module= rf_df
bootstrap_rf_kegg_module= bootstrap_model
err_rates_kegg_module= err_rates

save(rf_kegg_module, df_rf_kegg_module, bootstrap_rf_kegg_module, err_rates_kegg_module, file= paste0("/storage32Tb/sourav/HACK_REVISION/kegg_mod/",functionName,"_Output.RData"))