...
# code name- c102_function_pfam_abhishek.R
...
save.image(paste0("/storage32Tb/sourav/HACK_REVISION/pfam/",functionName,"_temp.RData"))

rf_df <- data.frame(Actual=rf_model$y,Predicted=rf_model$predicted)
save.image(paste0("/storage32Tb/sourav/HACK_REVISION/pfam/",functionName,"_temp.RData"))

pdf(file = paste0("/storage32Tb/sourav/HACK_REVISION/pfam/",functionName,"_FunctionCorPlot.pdf"), width = 15, height = 15);
...
rf_pfam= rf_model
df_rf_pfam= rf_df
bootstrap_rf_pfam= bootstrap_model
err_rates_pfam= err_rates

save(rf_pfam, df_rf_pfam, bootstrap_rf_pfam, err_rates_pfam, file= paste0("/storage32Tb/sourav/HACK_REVISION/pfam/",functionName,"_Output.RData"))