...
# code name- c102_function_kegg_ko_abhishek.R
...
save.image(paste0("/storage32Tb/sourav/HACK_REVISION/kegg_ko/",functionName,"_temp.RData"))

rf_df <- data.frame(Actual=rf_model$y,Predicted=rf_model$predicted)
save.image(paste0("/storage32Tb/sourav/HACK_REVISION/kegg_ko/",functionName,"_temp.RData"))

pdf(file = paste0("/storage32Tb/sourav/HACK_REVISION/kegg_ko/",functionName,"_FunctionCorPlot.pdf"), width = 15, height = 15);
...
rf_kegg_ko_core= rf_model
df_rf_kegg_ko_core= rf_df
bootstrap_rf_kegg_ko_core= bootstrap_model
err_rates_kegg_ko_core= err_rates

save(rf_kegg_ko_core, df_rf_kegg_ko_core, bootstrap_rf_kegg_ko_core, err_rates_kegg_ko_core, file= paste0("/storage32Tb/sourav/HACK_REVISION/kegg_ko/",functionName,"_Output.RData"))
