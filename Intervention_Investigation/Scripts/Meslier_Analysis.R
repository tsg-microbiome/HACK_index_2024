...
Meslier_V_2019_full_species <- Meslier_V_2019.species.matrix

SpeciesScores_NEW <- SpeciesScores_NEW[order(SpeciesScores_NEW[,4]),]
common_species <- intersect(rownames(SpeciesScores_NEW),colnames(Meslier_V_2019.species.matrix))
...
diff_NonHACKs_MED_weeks4_baseline <- apply(Meslier_V_2019_species[MED_weeks4,setdiff(common_species,rownames(tail(SpeciesScores_NEW),17))],1,mean)-apply(Meslier_V_2019_species[MED_baseline,setdiff(common_species,rownames(tail(SpeciesScores_NEW),17))],1,mean)
diff_HACKs_MED_weeks4_baseline <- apply(Meslier_V_2019_species[MED_weeks4,rownames(tail(SpeciesScores_NEW),17)],1,mean)-apply(Meslier_V_2019_species[MED_baseline,rownames(tail(SpeciesScores_NEW),17)],1,mean)

diff_NonHACKs_CONTROL_weeks4_baseline <- apply(Meslier_V_2019_species[CONTROL_weeks4,setdiff(common_species,rownames(tail(SpeciesScores_NEW),17))],1,mean)-apply(Meslier_V_2019_species[CONTROL_baseline,setdiff(common_species,rownames(tail(SpeciesScores_NEW),17))],1,mean)
diff_HACKs_CONTROL_weeks4_baseline <- apply(Meslier_V_2019_species[CONTROL_weeks4,rownames(tail(SpeciesScores_NEW),17)],1,mean)-apply(Meslier_V_2019_species[CONTROL_baseline,rownames(tail(SpeciesScores_NEW),17)],1,mean)

diff_NonHACKs_MED_weeks8_weeks4 <- apply(Meslier_V_2019_species[MED_weeks8,setdiff(common_species,rownames(tail(SpeciesScores_NEW),18))],1,mean)-apply(Meslier_V_2019_species[MED_weeks4,setdiff(common_species,rownames(tail(SpeciesScores_NEW),18))],1,mean)
diff_HACKs_MED_weeks8_weeks4 <- apply(Meslier_V_2019_species[MED_weeks8,rownames(tail(SpeciesScores_NEW),18)],1,mean)-apply(Meslier_V_2019_species[MED_weeks4,rownames(tail(SpeciesScores_NEW),18)],1,mean)
diff_NonHACKs_CONTROL_weeks8_weeks4 <- apply(Meslier_V_2019_species[CONTROL_weeks8,setdiff(common_species,rownames(tail(SpeciesScores_NEW),18))],1,mean)-apply(Meslier_V_2019_species[CONTROL_weeks4,setdiff(common_species,rownames(tail(SpeciesScores_NEW),18))],1,mean)
diff_HACKs_CONTROL_weeks8_weeks4 <- apply(Meslier_V_2019_species[CONTROL_weeks8,rownames(tail(SpeciesScores_NEW),18)],1,mean)-apply(Meslier_V_2019_species[CONTROL_weeks4,rownames(tail(SpeciesScores_NEW),18)],1,mean)

diff_NonHACKs_DecreasedMedDiet_weeks4_baseline <- apply(Meslier_V_2019_species[paste0(DecreasedMedDiet,"weeks4"),setdiff(common_species,rownames(tail(SpeciesScores_NEW),18))],1,mean)-apply(Meslier_V_2019_species[paste0(DecreasedMedDiet,"baseline"),setdiff(common_species,rownames(tail(SpeciesScores_NEW),18))],1,mean)
diff_HACKs_DecreasedMedDiet_weeks4_baseline <- apply(Meslier_V_2019_species[paste0(DecreasedMedDiet,"weeks4"),rownames(tail(SpeciesScores_NEW),18)],1,mean)-apply(Meslier_V_2019_species[paste0(DecreasedMedDiet,"baseline"),rownames(tail(SpeciesScores_NEW),18)],1,mean)
diff_NonHACKs_IncreasedMedDiet_weeks4_baseline <- apply(Meslier_V_2019_species[paste0(IncreasedMedDiet,"weeks4"),setdiff(common_species,rownames(tail(SpeciesScores_NEW),18))],1,mean)-apply(Meslier_V_2019_species[paste0(IncreasedMedDiet,"baseline"),setdiff(common_species,rownames(tail(SpeciesScores_NEW),18))],1,mean)
diff_HACKs_IncreasedMedDiet_weeks4_baseline <- apply(Meslier_V_2019_species[paste0(IncreasedMedDiet,"weeks4"),rownames(tail(SpeciesScores_NEW),18)],1,mean)-apply(Meslier_V_2019_species[paste0(IncreasedMedDiet,"baseline"),rownames(tail(SpeciesScores_NEW),18)],1,mean)

HACK_Species <- rownames(SpeciesScores_NEW[SpeciesScores_NEW[,4]>=0.75,])
...
CorrDietSpecies$HACK <- SpeciesScores_NEW[rownames(corr_diet_species$r),4]
...
CorrMEDDiffDietSpecies$HACK <- SpeciesScores_NEW[rownames(corr_MED_diff_diet_species$r),4]
...
CorrCONTROLDiffDietSpecies$HACK <- SpeciesScores_NEW[rownames(corr_CONTROL_diff_diet_species$r),4]
...
df_CorrMedDietScoreSpecies$HACK <- SpeciesScores_NEW[rownames(df_CorrMedDietScoreSpecies),4]
...
df_CorrMEDDiffSpeciesMedAdherence$HACK <- SpeciesScores_NEW[rownames(df_CorrMEDDiffSpeciesMedAdherence),4]
...
df_CorrCONTROLDiffSpeciesMedAdherence$HACK <- SpeciesScores_NEW[rownames(df_CorrCONTROLDiffSpeciesMedAdherence),4]
...
HACKs <- rownames(tail(SpeciesScores_NEW,18))
...
boxplot(Meslier_V_2019_diet_metadata[,"ItMedIndex"]~Meslier_V_2019_diet_metadata[,"Groups"],col="coral2",cex.axis=2)

corr_Species_Med_CONTROL_baseline <- corr.test(Meslier_V_2019_species[CONTROL_baseline,intersect(rownames(SpeciesScores_NEW),colnames(Meslier_V_2019_species))],Meslier_V_2019_diet_metadata[CONTROL_baseline,"ItMedIndex"])

dfCorrSpeciesMED_Control_baseline <- data.frame(r=apply(corr_Species_Med_CONTROL_baseline$r,2,function(x)(ifelse(is.na(x),0,x))),HACK=SpeciesScores_NEW[intersect(rownames(SpeciesScores_NEW),colnames(Meslier_V_2019_species)),4])

ggplot(dfCorrSpeciesMED_Control_baseline,aes(x=r,y=HACK))+geom_point()+geom_smooth(method="lm") + theme_bw() + theme(axis.text.x=element_text(size=20),axis.text.y=element_text(size=20))

corr_Species_Med_CONTROL_weeks4 <- corr.test(Meslier_V_2019_species[CONTROL_weeks4,intersect(rownames(SpeciesScores_NEW),colnames(Meslier_V_2019_species))],Meslier_V_2019_diet_metadata[CONTROL_weeks4,"ItMedIndex"])

dfCorrSpeciesMED_Control_weeks4 <- data.frame(r=apply(corr_Species_Med_CONTROL_weeks4$r,2,function(x)(ifelse(is.na(x),0,x))),HACK=SpeciesScores_NEW[intersect(rownames(SpeciesScores_NEW),colnames(Meslier_V_2019_species)),4])

ggplot(dfCorrSpeciesMED_Control_weeks4,aes(x=r,y=HACK))+geom_point()+geom_smooth(method="lm") + theme_bw() + theme(axis.text.x=element_text(size=20),axis.text.y=element_text(size=20))

corr_Species_Med_CONTROL_weeks8 <- corr.test(Meslier_V_2019_species[CONTROL_weeks8,intersect(rownames(SpeciesScores_NEW),colnames(Meslier_V_2019_species))],Meslier_V_2019_diet_metadata[CONTROL_weeks8,"ItMedIndex"])

dfCorrSpeciesMED_Control_weeks8 <- data.frame(r=apply(corr_Species_Med_CONTROL_weeks8$r,2,function(x)(ifelse(is.na(x),0,x))),HACK=SpeciesScores_NEW[intersect(rownames(SpeciesScores_NEW),colnames(Meslier_V_2019_species)),4])

ggplot(dfCorrSpeciesMED_Control_weeks8,aes(x=r,y=HACK))+geom_point()+geom_smooth(method="lm") + theme_bw() + theme(axis.text.x=element_text(size=20),axis.text.y=element_text(size=20))

corr_Species_Med_MED_baseline <- corr.test(Meslier_V_2019_species[MED_baseline,intersect(rownames(SpeciesScores_NEW),colnames(Meslier_V_2019_species))],Meslier_V_2019_diet_metadata[MED_baseline,"ItMedIndex"])

dfCorrSpeciesMED_MED_baseline <- data.frame(r=apply(corr_Species_Med_MED_baseline$r,2,function(x)(ifelse(is.na(x),0,x))),HACK=SpeciesScores_NEW[intersect(rownames(SpeciesScores_NEW),colnames(Meslier_V_2019_species)),4])
...
corr_Species_Med_MED_weeks4 <- corr.test(Meslier_V_2019_species[MED_weeks4,intersect(rownames(SpeciesScores_NEW),colnames(Meslier_V_2019_species))],Meslier_V_2019_diet_metadata[MED_weeks4,"ItMedIndex"])

dfCorrSpeciesMED_MED_weeks4 <- data.frame(r=apply(corr_Species_Med_MED_weeks4$r,2,function(x)(ifelse(is.na(x),0,x))),HACK=SpeciesScores_NEW[intersect(rownames(SpeciesScores_NEW),colnames(Meslier_V_2019_species)),4])
...
corr_Species_Med_MED_weeks8 <- corr.test(Meslier_V_2019_species[MED_weeks8,intersect(rownames(SpeciesScores_NEW),colnames(Meslier_V_2019_species))],Meslier_V_2019_diet_metadata[MED_weeks8,"ItMedIndex"])

dfCorrSpeciesMED_MED_weeks8 <- data.frame(r=apply(corr_Species_Med_MED_weeks8$r,2,function(x)(ifelse(is.na(x),0,x))),HACK=SpeciesScores_NEW[intersect(rownames(SpeciesScores_NEW),colnames(Meslier_V_2019_species)),4])

ggplot(dfCorrSpeciesMED_MED_weeks8,aes(x=r,y=HACK))+geom_point()+geom_smooth(method="lm") + theme_bw() + theme(axis.text.x=element_text(size=20),axis.text.y=element_text(size=20))
...
Sfa_Pufa <- rank_scale(Meslier_V_2019_diet_metadata[,"sfa_g"]/Meslier_V_2019_diet_metadata[,"pufa_g"])

Meslier_V_2019_diet_rankscaled$Sfa_Pufa <- Sfa_Pufa

CorrSpeciesDiet <- corr.test(Meslier_V_2019_species,Meslier_V_2019_diet_rankscaled[rownames(Meslier_V_2019_species),],adjust="fdr",use="pairwise.complete")

df_r_CorrSpeciesDiet <- as.data.frame(CorrSpeciesDiet$r)
df_r_CorrSpeciesDiet$HACK <- SpeciesScores_NEW[rownames(df_r_CorrSpeciesDiet),4]

df_HACKs_Diet <- data.frame("r"=corr.test(df_r_CorrSpeciesDiet,method="spearman",adjust="fdr")$r[1:14,15],"p"=corr.test(df_r_CorrSpeciesDiet,method="spearman",adjust="fdr")$p[1:14,15])
