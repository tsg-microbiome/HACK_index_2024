#### Its the revised code of c73_diseaseAnalysisFunction.R (This is for IndustrializedUrban only.)
...
diseaseAnalysisIterationPipeline= function(iteration, allDiseases, controlSampleList, diseaseSampleList, MainOutputFolder, AllCombinedSpProfile, species_to_check)
{
  ...
  for(repeation in 1:iteration)
  {
    ...
    totalSelected_diseases= round((25*0.65),0)
    
    selectedIndex= sample(seq(1, 25), totalSelected_diseases, replace = FALSE)
