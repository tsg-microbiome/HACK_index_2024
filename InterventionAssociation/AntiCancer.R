...
G1 <- rownames(tail(SpeciesScores,30))
G2 <- rownames(head(tail(SpeciesScores,60),30))
G3 <- rownames(head(tail(SpeciesScores,90),30))
G4 <- rownames(head(tail(SpeciesScores,120),30))
G5 <- rownames(head(tail(SpeciesScores,150),30))
G6 <- rownames(head(tail(SpeciesScores,180),30))
G7 <- rownames(head(SpeciesScores,16))
...
FrankelAE_2017_species <- as.data.frame(FrankelAE_2017_species[,intersect(rownames(SpeciesScores),colnames(FrankelAE_2017_species))]/rowSums(FrankelAE_2017_species[,intersect(rownames(SpeciesScores),colnames(FrankelAE_2017_species))]))

#Temporary rank scaling
#FrankelAE_2017_species <- as.data.frame(apply(FrankelAE_2017_species,2,rank_scale))


FrankelAE_2017_sp_responders <- FrankelAE_2017_species[rownames(FrankelAE_2017_metadata)[FrankelAE_2017_metadata$ORR=="yes"],intersect(rownames(SpeciesScores),colnames(FrankelAE_2017_species))]

FrankelAE_2017_sp_non_responders <- FrankelAE_2017_species[rownames(FrankelAE_2017_metadata)[FrankelAE_2017_metadata$ORR=="no"],intersect(rownames(SpeciesScores),colnames(FrankelAE_2017_species))]
...
wilcox_FrankelAE_2017$HACK <- SpeciesScores[rownames(wilcox_FrankelAE_2017),4]

df_FrankelAE_2017_HACKGrouped <- data.frame("G1"=rowMeans(apply(FrankelAE_2017_species[,intersect(G1,colnames(FrankelAE_2017_species))],2,rank_scale)),"G2"=rowMeans(apply(FrankelAE_2017_species[,intersect(G2,colnames(FrankelAE_2017_species))],2,rank_scale)),"G3"=rowMeans(apply(FrankelAE_2017_species[,intersect(G3,colnames(FrankelAE_2017_species))],2,rank_scale)),"G4"=rowMeans(apply(FrankelAE_2017_species[,intersect(G4,colnames(FrankelAE_2017_species))],2,rank_scale)),"G5"=rowMeans(apply(FrankelAE_2017_species[,intersect(G5,colnames(FrankelAE_2017_species))],2,rank_scale)),"G6"=rowMeans(apply(FrankelAE_2017_species[,intersect(G6,colnames(FrankelAE_2017_species))],2,rank_scale)),"G7"=rowMeans(apply(FrankelAE_2017_species[,intersect(G7,colnames(FrankelAE_2017_species))],2,rank_scale)))
...
GopalakrishnanV_2018_species <- GopalakrishnanV_2018_species[,intersect(rownames(SpeciesScores),colnames(GopalakrishnanV_2018_species))]/rowSums(GopalakrishnanV_2018_species[,intersect(rownames(SpeciesScores),colnames(GopalakrishnanV_2018_species))])
...
LeeKA_2022_species <- LeeKA_2022_species[,intersect(rownames(SpeciesScores),colnames(LeeKA_2022_species))]/rowSums(LeeKA_2022_species[,intersect(rownames(SpeciesScores),colnames(LeeKA_2022_species))])

#Temporary rank scaling
#LeeKA_2022_species <- as.data.frame(apply(LeeKA_2022_species,2,rank_scale))


LeeKA_2022_sp_responders <- LeeKA_2022_species[rownames(LeeKA_2022_metadata)[LeeKA_2022_metadata$ORR=="yes"],intersect(rownames(SpeciesScores),colnames(LeeKA_2022_species))]

LeeKA_2022_sp_non_responders <- LeeKA_2022_species[rownames(LeeKA_2022_metadata)[LeeKA_2022_metadata$ORR=="no"],intersect(rownames(SpeciesScores),colnames(LeeKA_2022_species))]
...
wilcox_LeeKA_2022$HACK <- SpeciesScores[rownames(wilcox_LeeKA_2022),4]

df_LeeKA_2022_HACKGrouped <- data.frame("G1"=rowMeans(apply(LeeKA_2022_species[,intersect(G1,colnames(LeeKA_2022_species))],2,rank_scale)),"G2"=rowMeans(apply(LeeKA_2022_species[,intersect(G2,colnames(LeeKA_2022_species))],2,rank_scale)),"G3"=rowMeans(apply(LeeKA_2022_species[,intersect(G3,colnames(LeeKA_2022_species))],2,rank_scale)),"G4"=rowMeans(apply(LeeKA_2022_species[,intersect(G4,colnames(LeeKA_2022_species))],2,rank_scale)),"G5"=rowMeans(apply(LeeKA_2022_species[,intersect(G5,colnames(LeeKA_2022_species))],2,rank_scale)),"G6"=rowMeans(apply(LeeKA_2022_species[,intersect(G6,colnames(LeeKA_2022_species))],2,rank_scale)),"G7"=rowMeans(apply(LeeKA_2022_species[,intersect(G7,colnames(LeeKA_2022_species))],2,rank_scale)))
...
MatsonV_2018_species <- MatsonV_2018_species[,intersect(rownames(SpeciesScores),colnames(MatsonV_2018_species))]/rowSums(MatsonV_2018_species[,intersect(rownames(SpeciesScores),colnames(MatsonV_2018_species))])

#Temporary rank scaling
#MatsonV_2018_species <- as.data.frame(apply(MatsonV_2018_species,2,rank_scale))


MatsonV_2018_sp_responders <- MatsonV_2018_species[rownames(MatsonV_2018_metadata)[MatsonV_2018_metadata$anti_PD_1 =="responder"],intersect(rownames(SpeciesScores),colnames(MatsonV_2018_species))]

MatsonV_2018_sp_non_responders <- MatsonV_2018_species[rownames(MatsonV_2018_metadata)[MatsonV_2018_metadata$anti_PD_1 =="non_responder"],intersect(rownames(SpeciesScores),colnames(MatsonV_2018_species))]
...
wilcox_MatsonV_2018$HACK <- SpeciesScores[rownames(wilcox_MatsonV_2018),4]

df_MatsonV_2018_HACKGrouped <- data.frame("G1"=rowMeans(apply(MatsonV_2018_species[,intersect(G1,colnames(MatsonV_2018_species))],2,rank_scale)),"G2"=rowMeans(apply(MatsonV_2018_species[,intersect(G2,colnames(MatsonV_2018_species))],2,rank_scale)),"G3"=rowMeans(apply(MatsonV_2018_species[,intersect(G3,colnames(MatsonV_2018_species))],2,rank_scale)),"G4"=rowMeans(apply(MatsonV_2018_species[,intersect(G4,colnames(MatsonV_2018_species))],2,rank_scale)),"G5"=rowMeans(apply(MatsonV_2018_species[,intersect(G5,colnames(MatsonV_2018_species))],2,rank_scale)),"G6"=rowMeans(apply(MatsonV_2018_species[,intersect(G6,colnames(MatsonV_2018_species))],2,rank_scale)),"G7"=rowMeans(apply(MatsonV_2018_species[,intersect(G7,colnames(MatsonV_2018_species))],2,rank_scale)))
...
WindTT_2020_species <- WindTT_2020_species[,intersect(rownames(SpeciesScores),colnames(WindTT_2020_species))]/rowSums(WindTT_2020_species[,intersect(rownames(SpeciesScores),colnames(WindTT_2020_species))])

#Temporary rank scaling
#WindTT_2020_species <- as.data.frame(apply(WindTT_2020_species,2,rank_scale))

WindTT_2020_sp_responders <- WindTT_2020_species[rownames(WindTT_2020_metadata)[WindTT_2020_metadata$ORR=="yes"],intersect(rownames(SpeciesScores),colnames(WindTT_2020_species))]

WindTT_2020_sp_non_responders <- WindTT_2020_species[rownames(WindTT_2020_metadata)[WindTT_2020_metadata$ORR=="no"],intersect(rownames(SpeciesScores),colnames(WindTT_2020_species))]
...
wilcox_WindTT_2020$HACK <- SpeciesScores[rownames(wilcox_WindTT_2020),4]

df_WindTT_2020_HACKGrouped <- data.frame("G1"=rowMeans(apply(WindTT_2020_species[,intersect(G1,colnames(WindTT_2020_species))],2,rank_scale)),"G2"=rowMeans(apply(WindTT_2020_species[,intersect(G2,colnames(WindTT_2020_species))],2,rank_scale)),"G3"=rowMeans(apply(WindTT_2020_species[,intersect(G3,colnames(WindTT_2020_species))],2,rank_scale)),"G4"=rowMeans(apply(WindTT_2020_species[,intersect(G4,colnames(WindTT_2020_species))],2,rank_scale)),"G5"=rowMeans(apply(WindTT_2020_species[,intersect(G5,colnames(WindTT_2020_species))],2,rank_scale)),"G6"=rowMeans(apply(WindTT_2020_species[,intersect(G6,colnames(WindTT_2020_species))],2,rank_scale)),"G7"=rowMeans(apply(WindTT_2020_species[,intersect(G7,colnames(WindTT_2020_species))],2,rank_scale)))
...
RoutyB_2018_species <- RoutyB_2018_species[,intersect(rownames(SpeciesScores),colnames(RoutyB_2018_species))]/rowSums(RoutyB_2018_species[,intersect(rownames(SpeciesScores),colnames(RoutyB_2018_species))])

#Temporary rank scaling
#RoutyB_2018_species <- as.data.frame(apply(RoutyB_2018_species,2,rank_scale))

RoutyB_2018_sp_responders <- RoutyB_2018_species[rownames(RoutyB_2018_metadata)[RoutyB_2018_metadata$anti_PD_1 =="responder"],intersect(rownames(SpeciesScores),colnames(RoutyB_2018_species))]

RoutyB_2018_sp_non_responders <- RoutyB_2018_species[rownames(RoutyB_2018_metadata)[RoutyB_2018_metadata$anti_PD_1 =="non_responder"],intersect(rownames(SpeciesScores),colnames(RoutyB_2018_species))]
...
wilcox_RoutyB_2018$HACK <- SpeciesScores[rownames(wilcox_RoutyB_2018),4]

df_RoutyB_2018_HACKGrouped <- data.frame("G1"=rowMeans(apply(RoutyB_2018_species[,intersect(G1,colnames(RoutyB_2018_species))],2,rank_scale)),"G2"=rowMeans(apply(RoutyB_2018_species[,intersect(G2,colnames(RoutyB_2018_species))],2,rank_scale)),"G3"=rowMeans(apply(RoutyB_2018_species[,intersect(G3,colnames(RoutyB_2018_species))],2,rank_scale)),"G4"=rowMeans(apply(RoutyB_2018_species[,intersect(G4,colnames(RoutyB_2018_species))],2,rank_scale)),"G5"=rowMeans(apply(RoutyB_2018_species[,intersect(G5,colnames(RoutyB_2018_species))],2,rank_scale)),"G6"=rowMeans(apply(RoutyB_2018_species[,intersect(G6,colnames(RoutyB_2018_species))],2,rank_scale)),"G7"=rowMeans(apply(RoutyB_2018_species[,intersect(G7,colnames(RoutyB_2018_species))],2,rank_scale)))
...
temp0 <- merge(t(df_RoutyB_2018_HACKGrouped[,c(1:7)]),t(df_FrankelAE_2017_HACKGrouped[,c(1:7)]),by="row.names",all=TRUE)[,-1]
rownames(temp0) <- merge(t(df_RoutyB_2018_HACKGrouped[,c(1:7)]),t(df_FrankelAE_2017_HACKGrouped[,c(1:7)]),by="row.names",all=TRUE)[,1]
temp0 <- apply(temp0,1,function(x)(ifelse(is.na(x),0,x)))

temp1 <- merge(t(temp0),t(df_LeeKA_2022_HACKGrouped[,c(1:7)]),by="row.names",all=TRUE)[,-1]
rownames(temp1) <- merge(t(temp0),t(df_LeeKA_2022_HACKGrouped[,c(1:7)]),by="row.names",all=TRUE)[,1]
temp1 <- apply(temp1,1,function(x)(ifelse(is.na(x),0,x)))

temp2 <- merge(t(temp1),t(df_MatsonV_2018_HACKGrouped[,c(1:7)]),by="row.names",all=TRUE)[,-1]
rownames(temp2) <- merge(t(temp1),t(df_MatsonV_2018_HACKGrouped[,c(1:7)]),by="row.names",all=TRUE)[,1]
temp2 <- apply(temp2,1,function(x)(ifelse(is.na(x),0,x)))

temp3 <- merge(t(temp2),t(df_WindTT_2020_HACKGrouped[,c(1:7)]),by="row.names",all=TRUE)[,-1]
rownames(temp3) <- merge(t(temp2),t(df_WindTT_2020_HACKGrouped[,c(1:7)]),by="row.names",all=TRUE)[,1]
...
temp3 <- merge(t(temp2),t(WindTT_2020_species[,setdiff(colnames(MatsonV_2018_species),c("study_name","study_name"))]),by="row.names",all=TRUE)[,-1]
rownames(temp3) <- merge(t(temp2),t(WindTT_2020_species[,setdiff(colnames(MatsonV_2018_species),c("study_name","study_name"))]),by="row.names",all=TRUE)[,1]
temp3 <- apply(temp3,1,function(x)(ifelse(is.na(x),0,x)))
...
Species_REM_Response <- as.data.frame(batch_rem2_grouped(AllStudies_species,AllStudies_species,intersect(rownames(SpeciesScores),colnames(AllStudies_species)),"binary_response","study_name",unique(AllStudies_species$study_name)))

Species_REM_Response$TaxaType <- ifelse(rownames(Species_REM_Response) %in% TopHACKs,"Darkolivegreen2",ifelse(rownames(Species_REM_Response) %in% MidHACKs,"gold2","firebrick3"))

Species_REM_Response$HACK <- SpeciesScores[rownames(Species_REM_Response),4]

ggplot(Species_REM_Response[Species_REM_Response$consistency>=0.8,],aes(x=est,y=-log(pval,10)))+geom_point(col=Species_REM_Response[Species_REM_Response$consistency>=0.8,"TaxaType"],size=2)+geom_hline(yintercept=0)+geom_vline(xintercept=0)+theme_bw()+theme(axis.text.x=element_text(size=15),axis.text.y=element_text(size=15))

ggplot(Species_REM_Response[Species_REM_Response$consistency>=0.8,],aes(x=est,y=HACK))+geom_point(col=Species_REM_Response[Species_REM_Response$consistency>=0.8,"TaxaType"],size=2)+geom_smooth(method='lm')+theme_bw()+theme(axis.text.x=element_text(size=15),axis.text.y=element_text(size=15))
...
LODO_Matrix <- matrix(NA,length(Study_Names),5)
rownames(LODO_Matrix) <- Study_Names
colnames(LODO_Matrix) <- c("All_Species","LowHACKs","MidHACKs","TopHACKs","All_Others")

for(i in 1:length(Study_Names))
{
	study <- Study_Names[i]
	train_data <- AllStudies_species[AllStudies_species$study_name != study,]
	test_data <- AllStudies_species[AllStudies_species$study_name == study,]
	
	train_data_all_species <- train_data[,intersect(colnames(AllStudies_species),c(TopHACKs,MidHACKs,LowHACKs))]
	
	train_data_LowHACKs <- train_data[,intersect(colnames(AllStudies_species),c(LowHACKs))]
	train_data_MidHACKs <- train_data[,intersect(colnames(AllStudies_species),c(MidHACKs))]
	train_data_TopHACKs <- train_data[,intersect(colnames(AllStudies_species),c(TopHACKs))]
	
	train_data_AllOthers <- train_data_all_species[,setdiff(colnames(train_data_all_species),c(TopHACKs))]
	
	rf_model_AllSpecies <- randomForest(as.factor(train_data[,"binary_response"])~.,train_data_all_species)
	rf_model_LowHACKs <- randomForest(as.factor(train_data[,"binary_response"])~.,train_data_LowHACKs)
	rf_model_MidHACKs <- randomForest(as.factor(train_data[,"binary_response"])~.,train_data_MidHACKs)
	rf_model_TopHACKs <- randomForest(as.factor(train_data[,"binary_response"])~.,train_data_TopHACKs)
	rf_model_AllOthers <- randomForest(as.factor(train_data[,"binary_response"])~.,train_data_AllOthers)
	
	test_data_all_species <- test_data[,intersect(colnames(AllStudies_species),c(TopHACKs,MidHACKs,LowHACKs))]
	
	test_data_LowHACKs <- test_data[,intersect(colnames(AllStudies_species),c(LowHACKs))]
	test_data_MidHACKs <- test_data[,intersect(colnames(AllStudies_species),c(MidHACKs))]
	test_data_TopHACKs <- test_data[,intersect(colnames(AllStudies_species),c(TopHACKs))]
	
	test_data_AllOthers <- test_data_all_species[,setdiff(colnames(test_data_all_species),c(TopHACKs))]

	LODO_Matrix[i,1] <- as.numeric(auc(test_data[,"binary_response"],predict(rf_model_AllSpecies,test_data_all_species,type="vote",norm.votes=TRUE)[,2])[1])
	LODO_Matrix[i,2] <- as.numeric(auc(test_data[,"binary_response"],predict(rf_model_LowHACKs,test_data_LowHACKs,type="vote",norm.votes=TRUE)[,2])[1])
	LODO_Matrix[i,3] <- as.numeric(auc(test_data[,"binary_response"],predict(rf_model_MidHACKs,test_data_MidHACKs,type="vote",norm.votes=TRUE)[,2])[1])
	LODO_Matrix[i,4] <- as.numeric(auc(test_data[,"binary_response"],predict(rf_model_TopHACKs,test_data_TopHACKs,type="vote",norm.votes=TRUE)[,2])[1])
	LODO_Matrix[i,5] <- as.numeric(auc(test_data[,"binary_response"],predict(rf_model_AllOthers,test_data_AllOthers,type="vote",norm.votes=TRUE)[,2])[1])
	
	assign(paste0("rf_model_",study),randomForest(as.factor(test_data[,"binary_response"])~.,test_data_all_species))
}
...
Directions_Species <- as.data.frame(matrix(0,length(intersect(rownames(SpeciesScores),colnames(AllStudies_species))),length(Study_Names)))
rownames(Directions_Species) <- intersect(rownames(SpeciesScores),colnames(AllStudies_species))
...
ggplot(Groups_Batch_REM_Response[,],aes(x=est,y=-log(pval,10)))+geom_point(col=Groups_Batch_REM_Response[,"TaxaType"],size=2)+geom_hline(yintercept=0)+geom_vline(xintercept=0)+theme_bw()+theme(axis.text.x=element_text(size=15),axis.text.y=element_text(size=15)) + geom_hline(yintercept=-log(0.05,10))+geom_text_repel(label=ifelse(Groups_Batch_REM_Response[,"pval"]<=0.05,rownames(Groups_Batch_REM_Response),""),max.overlaps=20)
...
boxplot(SpeciesScores[rownames(Cumulate_Directions),4]~cut(Cumulate_Directions[,1]-Cumulate_Directions[,2],breaks=c(-5,-2,0,2,5),include.lowest=TRUE),xlab="",ylab="",col=c("Violetred2","Yellow2","Slateblue2","Darkolivegreen"))
